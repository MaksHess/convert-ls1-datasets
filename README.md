...
| deconvolved image    | deconv.ome.zarr                     | multiscale (t, c, z, y, x)          | OME-Zarr v0.5                                                                     |       |
| nucleus segmentation | deconv.ome.zarr/labels/nucleus      | multiscale (t, z, y, x)             | OME-Zarr v0.5                                                                     |       |
...
| posix timestamps     | deconv.ome.zarr/tables/timestamps   | ngio:GenericTable (parquet-backend) | [ngio table](https://biovisioncenter.github.io/ngio/stable/table_specs/overview/) |       |
| lineage tree         | deconv.ome.zarr/tracks/nucleus.geff | geff:tracks                         | [GEFF v1.2](https://liveimagetrackingtools.org/geff/v1.3.0.1.2/specification/)                                                                         |       |